...
const pt = {
  ...
  controlRoom: {
    ...
    orgsDominiosAjuda: "Separe domínios por vírgula ou Enter.",
    orgsCancelar: "Cancelar",
    orgsSalvar: "Salvar",
    orgsCriar: "Criar organização",
    orgsErroCampos: "Informe um nome e pelo menos um domínio válido.",
...
const en: { [K in keyof Dicionario]: { [C in keyof Dicionario[K]]: string } } = {
  ...
  controlRoom: {
    ...
    orgsDominiosAjuda: "Separate domains with commas or Enter.",
    orgsCancelar: "Cancel",
    orgsSalvar: "Save",
    orgsCriar: "Create organization",
    orgsErroCampos: "Enter a name and at least one valid domain.",
