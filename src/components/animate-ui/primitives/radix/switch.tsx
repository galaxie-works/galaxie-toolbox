...
function Switch(props: SwitchProps) {
  // As props do Radix (checked, onCheckedChange, name...) vao SO para o Root.
  // O original espalhava `props` tambem no motion.button, que e um elemento
  // DOM - o React entao avisava "Unknown event handler property
  // onCheckedChange. It will be ignored." e sujava o console.
  const {
    checked,
    defaultChecked,
    onCheckedChange,
