/**
 * animated-border-button do registry @morphin, colado como veio, com duas
 * mudancas obrigatorias e nenhuma cosmetica:
 *
 * 1. O arquivo mora aqui, e nao em ui/button.tsx (alvo original), porque esse
 *    caminho ja e o Button do shadcn usado no app inteiro.
 * 2. O import do framer-motion saiu: `motion` e `HTMLMotionProps` eram
 *    importados e nunca usados, e instalar framer-motion ao lado do `motion`
 *    (sucessor, mesma versao) colocaria duas copias da biblioteca no bundle.
 */
