...
/**
 * Logo do Copilot, colado como veio.
 * Monocromatico: recebe fill="currentColor" para seguir a cor do texto
 * da sidebar (sem isso cairia no preto padrao do SVG e sumiria no escuro).
 *
