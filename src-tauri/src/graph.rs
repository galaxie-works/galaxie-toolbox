...
// seja disparada duas vezes quase junto — o boot do app e o keep-alive do
...
/// uma chave nova a cada chamada → o coalescing de agenda nunca casaria (dashboard vs.
...
/// #555 (P0): zera TODO o memo curto (chaveado por email:<escopo>/agenda,
...
/// Dois consumidores pedem a MESMA janela quase juntos; coalescer
